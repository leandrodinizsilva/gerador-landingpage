...
$page = $template_2->generateTemplate($userId);
if (!isset($localhost)) {
  $localhost = null;
}
?>
...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="..<?=$localhost; ?>/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

  <!-- Custom fonts for this template -->
  <link href="..<?=$localhost; ?>/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
  <link href="..<?=$localhost; ?>/vendor/simple-line-icons/css/simple-line-icons.css" rel="stylesheet" type="text/css">
  <link rel="stylesheet" media="screen" href="..<?=$localhost; ?>/assets/fonts/font-awesome/font-awesome.min.css" />
  <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic,700italic" rel="stylesheet" type="text/css">

  <!-- Custom styles for this template -->
  <link href="..<?=$localhost; ?>/css/landing-page.min.css" rel="stylesheet">
  <style>
    .main-color {
    ...
    .masthead {
      ...
      background: url("..<?=$localhost; ?>/admin/images/upload/<?=$page["main"]["data"][0]["background_image"];?>") no-repeat center center !important;
      background-size: cover;
    }
    .call-to-action {
      color: <?php echo "#".$page["main"]["data"][0]["secondary_text_color"] ?> !important;
      background: url("..<?=$localhost; ?>/admin/images/upload/<?=$page["footer"]["background_img"];?>") no-repeat center center !important;
    }
    .features-icons {
...
<body class="">
  ...
  <section class="showcase">
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        ...
        <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('..<?=$localhost; ?>/admin/images/upload/<?=$page["block2"]["image_1"];?>');"></div>
      ...
      <div class="row no-gutters">
        <div class="col-lg-6 text-white showcase-img" style="background-image: url('..<?=$localhost; ?>/admin/images/upload/<?=$page["block2"]["image_2"];?>');"></div>
      ...
      <div class="row no-gutters">
        <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('..<?=$localhost; ?>/admin/images/upload/<?=$page["block2"]["image_3"];?>');"></div>
        <div class="col-lg-6 order-lg-1 my-auto showcase-text">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="testimonial-item mx-auto mb-5 mb-lg-0">
            <img class="img-fluid rounded-circle mb-3" src="..<?=$localhost; ?>/admin/images/upload/<?=$page["testimonial"]["image_1"];?>" alt="">
        ...
        <div class="col-lg-4">
          <div class="testimonial-item mx-auto mb-5 mb-lg-0">
            <img class="img-fluid rounded-circle mb-3" src="..<?=$localhost; ?>/admin/images/upload/<?=$page["testimonial"]["image_2"];?>" alt="">
        ...
        <div class="col-lg-4">
          <div class="testimonial-item mx-auto mb-5 mb-lg-0">
            <img class="img-fluid rounded-circle mb-3" src="..<?=$localhost; ?>/admin/images/upload/<?=$page["testimonial"]["image_3"];?>" alt="">
  ...
  <script src="..<?=$localhost; ?>/vendor/jquery/jquery.min.js"></script>
  <script src="..<?=$localhost; ?>/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
